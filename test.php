...
<<<<<<< Updated upstream:orderform.php
<p>&nbsp;</p>
<div id="apDiv2">
...
<div class="row row-form">
 ...
 <h4>Sign Up</h4>
    ...
    I have read and agree to the *player guidelines<br>
    <div class="form-buttons">
    <input type="submit" value="Submit">
    <input type="reset" value="Reset"><br>
    </div>
>>>>>>> Stashed changes:orderform.html
<!-- InstanceEndEditable -->  
