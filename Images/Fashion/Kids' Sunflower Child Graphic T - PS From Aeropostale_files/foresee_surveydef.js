var $$FSR = {
  ...
  'embedded': false,
  'replay_id': 'aeropostale.com',
  'site_id': 'aeropostale.com',
  'attach': false,
  'renderer': 'W3C',
  // or "ASRECORDED"
  'layout': 'CENTERFIXED',
    ...
    invite: {
      ...
      dialogs: [
        [{
          ...
          blurb: "Thank you for visiting aeropostale.com. You have been selected to participate in a brief customer satisfaction survey to let us know how we can improve your experience.",
      ...
      exclude: {
        urls: ['/checkout/index.jsp', '/cart/index.jsp'],
        referrers: [],
        userAgents: [],
        browsers: [],
        cookies: [],
